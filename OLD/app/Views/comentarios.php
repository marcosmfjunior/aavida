...
<html>
    ...
    <div class="container">
        ...
        <?php
                    ...
                    echo '<br><div class="row"><div class="col-sm-12"><div class="panel panel-default">';
                    echo '<div class="panel-heading"><h4>' . $post->titulo . '</h4></div>';
	...
	?>
	<br /><br />	
	<form name="comentarios" method="post" action="comentarios.php">
