<html>
    ...
    <div class="container espacamento">
        <div class="titulo" ><h3>Notícias e Eventos</h3></div>     
        
         <input id="search" class="form-control" name="search" placeholder="Pesquisar notícia, ex: 2015, aavida, etc" type="text" data-list=".listaNoticias" autocomplete="off"> 
        
         <ul class="listaNoticias">
            <?php
                foreach($textos as $post){    
                    //$post->data = substr( $post->data, 0,10);                
                    ...
                    echo '<div class="col-sm-12"><li class="list-group-item" align="center">
                               <h4>' . $post->titulo . '</h4><small>'.$post->data.'</small></li></div></a>';
                }
            ?>
        </ul>
    </div>
